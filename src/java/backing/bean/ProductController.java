...
public class ProductController implements Serializable {
    ...
    public void create() {
        persist(PersistAction.CREATE, ResourceBundle.getBundle("localization/Bundle").getString("ProductCreated"));
    ...
    public void update() {
        persist(PersistAction.UPDATE, ResourceBundle.getBundle("localization/Bundle").getString("ProductUpdated"));
    }

    public void destroy() {
        persist(PersistAction.DELETE, ResourceBundle.getBundle("localization/Bundle").getString("ProductDeleted"));
        if (!JsfUtil.isValidationFailed()) {
